...
backlog-exporter-socks-plugin/0.0.2 darwin-arm64 node-v20.18.0
...
* [`backlog-exporter-socks-plugin socks-proxy PERSON`](#backlog-exporter-socks-plugin-socks-proxy-person)
...
## `backlog-exporter-socks-plugin socks-proxy PERSON`
...
EXAMPLES
  Display how to use the socks proxy

    $ backlog-exporter-socks-plugin socks-proxy
```

_See code: [src/commands/socks-proxy/index.ts](https://github.com/meltedice/backlog-exporter-socks-plugin/blob/v0.0.2/src/commands/socks-proxy/index.ts)_
<!-- commandsstop -->
